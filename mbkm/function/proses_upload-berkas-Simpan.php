...
<div class="mb-3">
  ...
  <p class="text-center"><button onclick="myFunction()" class="btn btn-success">SIMPAN</button></p>
...
function myFunction() {
  ...
  if (confirm("Apakah Anda Yakin?")) {
    txt = "Berkas Anda Terkirim!";
  } else {
    txt = "Berkas Anda Belum Terkirim!";
  }
...
<p>Komentar</p>
<form method="post"><textarea rows="4" cols="40" name="Komentar"></textarea></form>
</body>
</html>